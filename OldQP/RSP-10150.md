...
begin
  ...
  // Normally, the code that follows the above would continue with the LCipher reference (i.e. not LCipherObject), since the other methods can be called on that reference
end;
```
